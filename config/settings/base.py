...
DATABASES = {
    'default': {
        ...
        'NAME': config('POSTGRES_DB', default='ksef_invoices'),
        'USER': config('POSTGRES_USER', default='ksef'),
...
# KSeF
KSEF_TOKEN_ENCRYPTION_KEY = config('KSEF_TOKEN_ENCRYPTION_KEY', default='')

# Numer rachunku obciążanego (konto firmy w banku) — używany przy generowaniu plików płatności
